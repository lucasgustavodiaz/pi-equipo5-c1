export function RowUser(props) {
    const { id, name, lastName, dni, password, email, phone, adress, role } = props

    async function handleOnEditRole() {
        const hostUrl = process.env.NEXT_PUBLIC_USER_EDIT_URL
        ...
        if (opcion){
          try {
            ...
            console.error('Error al designar como administrador el registro:', error)
          }
      }
        }
